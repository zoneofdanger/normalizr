...
var _typeof =
  ...
  EntitySchema = (function() {
    function e(t) {
      ...
      if ((classCallCheck(this, e), !t || 'string' != typeof t))
    ...
    return (
      ...
      (e.prototype.normalize = function(e, t, n, r, i, o) {
        var a = this;
        if (
          o.some(function(t) {
            return t === e;
        ...
        return (
          Object.keys(this.schema).forEach(function(e) {
            if (u.hasOwnProperty(e) && 'object' === _typeof(u[e])) {
              var t = a.schema[e];
              u[e] = r(u[e], u, e, t, i, o);
            }
          }),
  ...
  PolymorphicSchema = (function() {
    ...
    return (
      ...
      (e.prototype.normalizeValue = function(e, t, n, r, i, o) {
  ...
  UnionSchema = (function(e) {
    function t(n, r) {
      if ((classCallCheck(this, t), !r)) throw new Error('Expected option "schemaAttribute" not found on UnionSchema.');
      return possibleConstructorReturn(this, e.call(this, n, r));
    }
    return (
      inherits(t, e),
      (t.prototype.normalize = function(e, t, n, r, i, o) {
    ...
    return (
      ...
      (t.prototype.normalize = function(e, t, n, r, i, o) {
        ...
        return Object.keys(e).reduce(function(t, n, u) {
          var c,
            s = e[n];
          return null != s ? _extends({}, t, (((c = {})[n] = a.normalizeValue(s, e, n, r, i, o)), c)) : t;
        }, {});
      }),
      (t.prototype.denormalize = function(e, t) {
        var n = this;
        return Object.keys(e).reduce(function(r, i) {
          var o,
            a = e[i];
          return _extends({}, r, (((o = {})[i] = n.denormalizeValue(a, t)), o));
        }, {});
      }),
      t
    );
  ...
  ObjectSchema = (function() {
    function e(t) {
      classCallCheck(this, e), this.define(t);
    }
    return (
      (e.prototype.define = function(e) {
        this.schema = Object.keys(e).reduce(function(t, n) {
  ...
  visit = function e(t, n, r, i, o, a) {
    return 'object' === (void 0 === t ? 'undefined' : _typeof(t)) && t
      ? 'object' !== (void 0 === i ? 'undefined' : _typeof(i)) || (i.normalize && 'function' == typeof i.normalize)
  ...
  unvisitEntity = function(e, t, n, r, i) {
    ...
    if ((i[t.key] || (i[t.key] = {}), !i[t.key][e])) {
      var a = isImmutable(o) ? o : _extends({}, o);
      (i[t.key][e] = a), (i[t.key][e] = t.denormalize(a, n));
    }
    return i[t.key][e];
  },
  getUnvisit = function(e) {
    ...
    return function e(r, i) {
      return 'object' !== (void 0 === i ? 'undefined' : _typeof(i)) ||
        (i.denormalize && 'function' == typeof i.denormalize)
        ? null == r
          ? r
  ...
  getEntities = function(e) {
    ...
    return function(n, r) {
      var i = r.key;
      return 'object' === (void 0 === n ? 'undefined' : _typeof(n)) ? n : t ? e.getIn([i, n.toString()]) : e[i][n];
    };
  },
  denormalize$1 = function(e, t, n) {
    if (void 0 !== e) return getUnvisit(n)(e, t);
  };
(exports.schema = schema), (exports.normalize = normalize$1), (exports.denormalize = denormalize$1);
