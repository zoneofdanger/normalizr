  ...
  var r =
    ...
    s = (function() {
        ...
        var o = r.idAttribute,
          ...
          p =
            void 0 === h
              ...
              : h;
        (this._key = e),
          (this._getId = 'function' == typeof c ? c : f(c)),
          (this._idAttribute = c),
      ...
      return (
        ...
        (t.prototype.normalize = function(t, e, n, i, o, u) {
          var c = this;
          if (
            u.some(function(e) {
              return e === t;
          ...
          return (
            Object.keys(this.schema).forEach(function(t) {
              if (a.hasOwnProperty(t) && 'object' === r(a[t])) {
                var e = c.schema[t];
                a[t] = i(a[t], a, t, e, o, u);
              }
            }),
        ...
        (t.prototype.denormalize = function(t, r) {
          var i = this;
          return e(t)
            ? n(this.schema, t, r)
    ...
    h = (function() {
      ...
      return (
        ...
        (t.prototype.normalizeValue = function(t, e, n, r, i, o) {
        ...
        (t.prototype.denormalizeValue = function(t, n) {
          var r = e(t) ? t.get('schema') : t.schema;
          return this.isSingleSchema || r
            ? n((e(t) ? t.get('id') : t.id) || t, this.isSingleSchema ? this.schema : this.schema[r])
            : t;
        }),
        o(t, [
          {
    ...
    p = (function(t) {
      function e(n, r) {
        if ((i(this, e), !r)) throw new Error('Expected option "schemaAttribute" not found on UnionSchema.');
        return a(this, t.call(this, n, r));
      }
      return (
        c(e, t),
        (e.prototype.normalize = function(t, e, n, r, i, o) {
      ...
      return (
        ...
        (e.prototype.normalize = function(t, e, n, r, i, o) {
          ...
          return Object.keys(t).reduce(function(e, n, a) {
            var f,
              s = t[n];
            return null != s ? u({}, e, (((f = {})[n] = c.normalizeValue(s, t, n, r, i, o)), f)) : e;
          }, {});
        }),
        (e.prototype.denormalize = function(t, e) {
          var n = this;
          return Object.keys(t).reduce(function(r, i) {
            var o,
              c = t[i];
            return u({}, r, (((o = {})[i] = n.denormalizeValue(c, e)), o));
          }, {});
        }),
        e
      );
    ...
    g = function(t, e, n, r, i, o, c) {
      var a = u({}, e);
      return (
        Object.keys(t).forEach(function(n) {
          var r = t[n],
            u = i(e[n], e, n, r, o, c);
          null == u ? delete a[n] : (a[n] = u);
        }),
        a
      );
    },
    S = function(t, r, i) {
      if (e(r)) return n(t, r, i);
      var o = u({}, r);
      return (
    ...
    j = { Array: v, Entity: s, Object: z, Union: p, Values: y },
    k = function(t) {
      var n = {},
        i = O(t);
      return function t(o, c) {
        return 'object' !== (void 0 === c ? 'undefined' : r(c)) || (c.denormalize && 'function' == typeof c.denormalize)
          ? null == o
            ? o
            : c instanceof s
              ? (function(t, n, i, o, c) {
                  var a = o(t, n);
                  if ('object' !== (void 0 === a ? 'undefined' : r(a)) || null === a) return a;
                  if ((c[n.key] || (c[n.key] = {}), !c[n.key][t])) {
                    var f = e(a) ? a : u({}, a);
                    (c[n.key][t] = f), (c[n.key][t] = n.denormalize(f, i));
                  }
                  return c[n.key][t];
                })(o, c, t, i, n)
              : c.denormalize(o, t)
          : (Array.isArray(c) ? b : S)(c, o, t);
      };
    },
    O = function(t) {
      var n = e(t);
      return function(e, i) {
        var o = i.key;
        return 'object' === (void 0 === e ? 'undefined' : r(e)) ? e : n ? t.getIn([o, e.toString()]) : t[o][e];
      };
    };
  (t.schema = j),
    (t.normalize = function(t, e) {
      ...
      return {
        entities: n,
        result: (function t(e, n, i, o, u, c) {
          return 'object' === (void 0 === e ? 'undefined' : r(e)) && e
            ? 'object' !== (void 0 === o ? 'undefined' : r(o)) || (o.normalize && 'function' == typeof o.normalize)
              ? o.normalize(e, n, i, t, u, c)
              : (Array.isArray(o) ? d : g)(o, e, n, i, t, u, c)
            : e;
        })(t, t, null, e, i, [])
      };
    }),
