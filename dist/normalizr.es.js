...
var EntitySchema = (function() {
  function EntitySchema(key) {
    ...
    var _options$idAttribute = options.idAttribute,
      ...
      mergeStrategy =
        _options$mergeStrateg === undefined
      ...
      processStrategy =
        _options$processStrat === undefined
          ? function(input) {
  ...
  EntitySchema.prototype.define = function define(definition) {
    this.schema = Object.keys(definition).reduce(function(entitySchema, key) {
      ...
      return _extends(
        {},
        entitySchema,
        ((_babelHelpers$extends = {}), (_babelHelpers$extends[key] = schema), _babelHelpers$extends)
      );
    }, this.schema || {});
  };
  ...
  EntitySchema.prototype.normalize = function normalize(input, parent, key, visit, addEntity, visitedEntities) {
    var _this = this;
...
var PolymorphicSchema = (function() {
  ...
  PolymorphicSchema.prototype.normalizeValue = function normalizeValue(
    value,
    parent,
    key,
    visit,
...
var UnionSchema = (function(_PolymorphicSchema) {
  ...
  UnionSchema.prototype.normalize = function normalize(input, parent, key, visit, addEntity, visitedEntities) {
...
var ValuesSchema = (function(_PolymorphicSchema) {
  ...
  ValuesSchema.prototype.normalize = function normalize(input, parent, key, visit, addEntity, visitedEntities) {
    var _this2 = this;
    ...
    return Object.keys(input).reduce(function(output, key, index) {
      ...
      return value !== undefined && value !== null
        ? _extends(
            ...
            (_babelHelpers$extends[key] = _this2.normalizeValue(value, input, key, visit, addEntity, visitedEntities)),
            _babelHelpers$extends)
          )
        : output;
    }, {});
  ...
  ValuesSchema.prototype.denormalize = function denormalize(input, unvisit) {
    ...
    return Object.keys(input).reduce(function(output, key) {
      ...
      return _extends(
        ...
        (_babelHelpers$extends2[key] = _this3.denormalizeValue(entityOrId, unvisit)),
        _babelHelpers$extends2)
      );
    }, {});
  };
...
var ArraySchema = (function(_PolymorphicSchema) {
  ...
  ArraySchema.prototype.normalize = function normalize(input, parent, key, visit, addEntity, visitedEntities) {
    var _this2 = this;
    ...
    return values
      .map(function(value, index) {
        return _this2.normalizeValue(value, parent, key, visit, addEntity, visitedEntities);
      })
...
var _normalize = function _normalize(schema, input, parent, key, visit, addEntity, visitedEntities) {
...
var visit = function visit(value, parent, key, schema, addEntity, visitedEntities) {
  ...
  if (
    (typeof schema === 'undefined' ? 'undefined' : _typeof(schema)) === 'object' &&
...
export { schema, normalize$1 as normalize, denormalize$1 as denormalize };
